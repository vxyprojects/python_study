...
# driver = webdriver.Chrome(executable_path="/Users/swlee/Downloads/chromedriver/chromedriver.exe")

driver = webdriver.Chrome('/Users/swlee/Downloads/chromedriver')
# driver = webdriver.Chrome(executable_path="/Users/swlee/Downloads/chromedriver")

for i in range(1, 101):
    driver.get("https://google.com")


    # print(os.path.exists('/Users/swlee/Documents/python/example/test.xls'))

    # os.path.exists('/Users/swlee/Documents/python/example/test.xls')
    # if ()
    # 엑셀 파일 열기
    if os.path.exists('/Users/swlee/Documents/python/example/test.xls') == True:
